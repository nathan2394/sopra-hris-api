...
{
    private readonly IServiceUnattendanceOVTAsync<EmployeeTransferShifts> _service;

    public EmployeeTransferShiftsController(IServiceUnattendanceOVTAsync<EmployeeTransferShifts> service)
    {
        _service = service;
    }
