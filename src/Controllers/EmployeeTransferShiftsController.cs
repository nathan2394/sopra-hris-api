...
{
    private readonly IServiceEmployeeTransferShiftAsync<EmployeeTransferShifts> _service;

    public EmployeeTransferShiftsController(IServiceEmployeeTransferShiftAsync<EmployeeTransferShifts> service)
    {
        _service = service;
    }
