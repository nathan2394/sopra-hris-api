...
[Route("[controller]")]
[Authorize]
public class IdeaAwardsController : ControllerBase
{
    private readonly IServiceAsync<IdeaAwards> _service;

    public IdeaAwardsController(IServiceAsync<IdeaAwards> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<IdeaAwards>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "IdeaAwardsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] IdeaAwards obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] IdeaAwards obj)
    {
        try
        {
