...
{
    private readonly IServiceAsync<EmployeeTypes> _service;

    public EmployeeTypeController(IServiceAsync<EmployeeTypes> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EmployeeTypes>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "EmployeeTypeController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeTypes obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EmployeeTypes obj)
    {
        try
        {
