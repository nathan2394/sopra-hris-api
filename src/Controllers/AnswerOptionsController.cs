...
{
    private readonly IServiceAsync<AnswerOptions> _service;

    public AnswerOptionsController(IServiceAsync<AnswerOptions> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<AnswerOptions>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "AnswerOptionsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AnswerOptions obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] AnswerOptions obj)
    {
        try
        {
