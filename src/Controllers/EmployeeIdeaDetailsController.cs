...
[Route("[controller]")]
[Authorize]
public class EmployeeIdeaDetailsController : ControllerBase
{
    private readonly IServiceAsync<EmployeeIdeaDetails> _service;

    public EmployeeIdeaDetailsController(IServiceAsync<EmployeeIdeaDetails> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EmployeeIdeaDetails>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "EmployeeIdeaDetailsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeIdeaDetails obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EmployeeIdeaDetails obj)
    {
        try
        {
