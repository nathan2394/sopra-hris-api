...
[ApiController]
[Route("[controller]")]
public class ApplicantFamilysController : ControllerBase
{
    private readonly IServiceAsync<ApplicantFamilys> _service;

    public ApplicantFamilysController(IServiceAsync<ApplicantFamilys> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<ApplicantFamilys>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ApplicantFamilys obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] ApplicantFamilys obj)
    {
        try
        {
