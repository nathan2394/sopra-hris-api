...
[ApiController]
[Route("[controller]")]
public class ApplicantSocialMediaController : ControllerBase
{
    private readonly IServiceAsync<ApplicantSocialMedia> _service;

    public ApplicantSocialMediaController(IServiceAsync<ApplicantSocialMedia> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<ApplicantSocialMedia>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ApplicantSocialMedia obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] ApplicantSocialMedia obj)
    {
        try
        {
