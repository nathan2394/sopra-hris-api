...
{
    private readonly IServiceAsync<EducationHistory> _service;

    public EducationHistoryController(IServiceAsync<EducationHistory> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EducationHistory>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EducationHistory obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EducationHistory obj)
    {
        try
        {
