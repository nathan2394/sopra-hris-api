...
[ApiController]
[Route("[controller]")]
public class JobVacancySourcesController : ControllerBase
{
    private readonly IServiceAsync<JobVacancySource> _service;

    public JobVacancySourcesController(IServiceAsync<JobVacancySource> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<JobVacancySource>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "JobVacancySourcesController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] JobVacancySource obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] JobVacancySource obj)
    {
        try
        {
