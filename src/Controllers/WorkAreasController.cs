...
{
    private readonly IServiceAsync<WorkAreas> _service;

    public WorkAreasController(IServiceAsync<WorkAreas> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<WorkAreas>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "WorkAreasController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] WorkAreas obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] WorkAreas obj)
    {
        try
        {
