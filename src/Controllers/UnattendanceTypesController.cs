...
[Route("[controller]")]
[Authorize]
public class UnattendanceTypesController : ControllerBase
{
    private readonly IServiceAsync<UnattendanceTypes> _service;

    public UnattendanceTypesController(IServiceAsync<UnattendanceTypes> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<UnattendanceTypes>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "UnattendanceTypesController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] UnattendanceTypes obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] UnattendanceTypes obj)
    {
        try
        {
