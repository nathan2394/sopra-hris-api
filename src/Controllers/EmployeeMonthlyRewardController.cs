...
[Route("[controller]")]
[Authorize]
public class EmployeeMonthlyRewardController : ControllerBase
{
    private readonly IServiceAsync<EmployeeMonthlyReward> _service;

    public EmployeeMonthlyRewardController(IServiceAsync<EmployeeMonthlyReward> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EmployeeMonthlyReward>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "EmployeeMonthlyRewardController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeMonthlyReward obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EmployeeMonthlyReward obj)
    {
        try
        {
