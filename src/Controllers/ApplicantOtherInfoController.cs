...
[ApiController]
[Route("[controller]")]
public class ApplicantOtherInfoController : ControllerBase
{
    private readonly IServiceAsync<ApplicantOtherInfo> _service;

    public ApplicantOtherInfoController(IServiceAsync<ApplicantOtherInfo> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<ApplicantOtherInfo>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ApplicantOtherInfo obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] ApplicantOtherInfo obj)
    {
        try
        {
