...
{
    private readonly IServiceAsync<WorkExperience> _service;

    public WorkExperienceController(IServiceAsync<WorkExperience> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<WorkExperience>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "WorkExperienceController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] WorkExperience obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] WorkExperience obj)
    {
        try
        {
