...
[Route("[controller]")]
[Authorize]
public class GroupShiftsController : ControllerBase
{
    private readonly IServiceAsync<GroupShifts> _service;

    public GroupShiftsController(IServiceAsync<GroupShifts> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<GroupShifts>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "GroupShiftsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] GroupShifts obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] GroupShifts obj)
    {
        try
        {
