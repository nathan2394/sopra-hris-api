...
[ApiController]
[Route("[controller]")]
public class OrganizationalHistoryController : ControllerBase
{
    private readonly IServiceAsync<OrganizationalHistory> _service;

    public OrganizationalHistoryController(IServiceAsync<OrganizationalHistory> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<OrganizationalHistory>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] OrganizationalHistory obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] OrganizationalHistory obj)
    {
        try
        {
