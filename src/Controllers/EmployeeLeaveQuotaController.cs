...
[Route("[controller]")]
[Authorize]
public class EmployeeLeaveQuotaController : ControllerBase
{
    private readonly IServiceAsync<EmployeeLeaveQuotas> _service;

    public EmployeeLeaveQuotaController(IServiceAsync<EmployeeLeaveQuotas> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EmployeeLeaveQuotas>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "EmployeeLeaveQuotaController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeLeaveQuotas obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EmployeeLeaveQuotas obj)
    {
        try
        {
