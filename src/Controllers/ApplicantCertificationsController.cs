...
[ApiController]
[Route("[controller]")]
public class ApplicantCertificationsController : ControllerBase
{
    private readonly IServiceAsync<ApplicantCertifications> _service;

    public ApplicantCertificationsController(IServiceAsync<ApplicantCertifications> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<ApplicantCertifications>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ApplicantCertifications obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] ApplicantCertifications obj)
    {
        try
        {
