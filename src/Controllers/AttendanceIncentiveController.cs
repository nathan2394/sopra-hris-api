...
[Route("[controller]")]
[Authorize]
public class AttendanceIncentiveController : ControllerBase
{
    private readonly IServiceAsync<AttendanceIncentive> _service;

    public AttendanceIncentiveController(IServiceAsync<AttendanceIncentive> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<AttendanceIncentive>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "AttendanceIncentiveController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AttendanceIncentive obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] AttendanceIncentive obj)
    {
        try
        {
