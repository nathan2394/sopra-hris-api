...
[Route("[controller]")]
[Authorize]
public class SupervisorBenefitController : ControllerBase
{
    private readonly IServiceAsync<SupervisorBenefit> _service;

    public SupervisorBenefitController(IServiceAsync<SupervisorBenefit> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<SupervisorBenefit>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "SupervisorBenefitController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] SupervisorBenefit obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] SupervisorBenefit obj)
    {
        try
        {
