...
public class BudgetingOvertimesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<BudgetingOvertimes>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] BudgetingOvertimes obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] BudgetingOvertimes obj)
    {
        try
        {
