...
public class FunctionDetailsController : ControllerBase
{
    ...
    public FunctionDetailsController(IServiceAsync<FunctionDetails> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<FunctionDetails>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "FunctionDetailsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] FunctionDetails obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] FunctionDetails obj)
    {
        try
        {
