...
[ApiController]
[Route("[controller]")]
public class OtherReferencesController : ControllerBase
{
    private readonly IServiceAsync<OtherReferences> _service;

    public OtherReferencesController(IServiceAsync<OtherReferences> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<OtherReferences>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] OtherReferences obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] OtherReferences obj)
    {
        try
        {
