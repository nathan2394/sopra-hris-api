...
[ApiController]
[Route("[controller]")]
public class DivisionDetailsController : ControllerBase
{
    private readonly IServiceAsync<DivisionDetails> _service;

    public DivisionDetailsController(IServiceAsync<DivisionDetails> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<DivisionDetails>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "DivisionDetailsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] DivisionDetails obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] DivisionDetails obj)
    {
        try
        {
