...
[ApiController]
[Route("[controller]")]
public class TestResponsesController : ControllerBase
{
    private readonly IServiceAsync<TestResponses> _service;

    public TestResponsesController(IServiceAsync<TestResponses> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<TestResponses>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "TestResponsesController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TestResponses obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] TestResponses obj)
    {
        try
        {
