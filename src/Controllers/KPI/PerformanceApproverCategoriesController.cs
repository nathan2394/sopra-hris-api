...
[Route("[controller]")]
[Authorize]
public class PerformanceApproverCategoriesController : ControllerBase
{
    private readonly IServicePerformanceApproverCategoryAsync<PerformanceApproverCategories> _service;

    public PerformanceApproverCategoriesController(IServicePerformanceApproverCategoryAsync<PerformanceApproverCategories> service)
    {
        _service = service;
    }
