...
[ApiController]
[Route("[controller]")]
public class ApplicantSkillListController : ControllerBase
{
    private readonly IServiceAsync<ApplicantSkillList> _service;

    public ApplicantSkillListController(IServiceAsync<ApplicantSkillList> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<ApplicantSkillList>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ApplicantSkillList obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] ApplicantSkillList obj)
    {
        try
        {
