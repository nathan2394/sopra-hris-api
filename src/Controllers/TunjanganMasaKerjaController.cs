...
[ApiController]
[Route("[controller]")]
public class TunjanganMasaKerjaController : ControllerBase
{
    private readonly IServiceAsync<TunjanganMasaKerja> _service;

    public TunjanganMasaKerjaController(IServiceAsync<TunjanganMasaKerja> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<TunjanganMasaKerja>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] TunjanganMasaKerja obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] TunjanganMasaKerja obj)
    {
        try
        {
