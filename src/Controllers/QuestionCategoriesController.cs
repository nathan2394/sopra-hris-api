...
{
    private readonly IServiceAsync<QuestionCategories> _service;

    public QuestionCategoriesController(IServiceAsync<QuestionCategories> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<QuestionCategories>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "QuestionCategoriesController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] QuestionCategories obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] QuestionCategories obj)
    {
        try
        {
