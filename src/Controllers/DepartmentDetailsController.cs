...
{
    private readonly IServiceAsync<DepartmentDetails> _service;

    public DepartmentDetailsController(IServiceAsync<DepartmentDetails> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        ...
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "DepartmentDetailsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] DepartmentDetails obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] DepartmentDetails obj)
    {
        try
        {
