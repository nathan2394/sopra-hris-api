...
{
    private readonly IServiceAsync<Questions> _service;

    public QuestionsController(IServiceAsync<Questions> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<Questions>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "QuestionsController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] Questions obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] Questions obj)
    {
        try
        {
