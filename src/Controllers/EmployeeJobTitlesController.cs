...
{
    private readonly IServiceAsync<EmployeeJobTitles> _service;

    public EmployeeJobTitlesController(IServiceAsync<EmployeeJobTitles> service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> GetById(int id)
    {
        try
        {
            ...
            var response = new Response<EmployeeJobTitles>(result);
            return Ok(response);
        }
        catch (Exception ex)
        {
            ...
            Trace.WriteLine(message, "EmployeeJobTitlesController");
            return BadRequest(new { message });
        }
    }

    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EmployeeJobTitles obj)
    {
        try
        {
    ...
    [HttpPut]
    public async Task<IActionResult> Edit([FromBody] EmployeeJobTitles obj)
    {
        try
        {
